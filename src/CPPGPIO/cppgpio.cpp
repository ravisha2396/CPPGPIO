...
namespace CPPGPIO
{
    ...
    /*
        ...
        This method returns the value on the input pin. 
        I added a shorthand if that checks if the _active_low bit is set. 
        If the active_low bit is set, then the pin value is inverted before it is returned.
    ...
    */
    ...
    // GPIO Output class definitions and method definitions are below
